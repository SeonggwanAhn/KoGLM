...
if __name__ == '__main__':
    ...
    elif args.task.lower() in ['cnn_dm', 'cnn_dm_original', 'gigaword', 'blank', 'squad', 'squad_v1', 'squad_generation', 'xsum',
                               'extraction', 'cmrc', 'korquad_extract', 'korquad_answer', 'aihub_summary']:
